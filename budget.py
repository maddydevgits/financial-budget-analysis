...
with colAnnualSal:
    salary = st.number_input("Enter your annual salary: ", min_value=0, format='%i')
with colTax:
    tax_rate = st.number_input("Enter your tax rate(%): ", min_value=0, format='%i')
...
with colExpenses1:
    ...
    monthly_rental = st.number_input("Enter your monthly rental: ", min_value=0,format='%d' )
    
    st.subheader("Daily Food Budget")
    daily_food = st.number_input("Enter your daily food budget : ", min_value=0,format='%d' )
    monthly_food = daily_food * 30
    
    st.subheader("Monthly Unforeseen Expenses")
    monthly_unforeseen = st.number_input("Enter your monthly unforeseen expenses: ", min_value=0,format='%d' ) 
    
with colExpenses2:
    st.subheader("Monthly Transport")
    monthly_transport = st.number_input("Enter your monthly transport fee: ", min_value=0,format='%d' )   
    
    st.subheader("Monthly Utilities Fees")
    monthly_utilities = st.number_input("Enter your monthly utilities fees: ", min_value=0,format='%d' )
    
    st.subheader("Monthly Entertainment Budget")
    monthly_entertainment = st.number_input("Enter your monthly entertainment budget: ", min_value=0,format='%d' )   
